<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.Master" AutoEventWireup="true" CodeBehind="addProject.aspx.cs" Inherits="OpalCelik.AdminPanel.addProject" %>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mt-2">
                            <div>
                                ...
                                <asp:FileUpload ID="FileUpload1" class="form-control" runat="server" required="required" />
                            </div>
                            <div class="mt-10">
